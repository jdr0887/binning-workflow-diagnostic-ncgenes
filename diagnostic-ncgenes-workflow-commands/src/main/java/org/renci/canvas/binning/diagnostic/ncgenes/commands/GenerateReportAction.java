...
import org.renci.canvas.binning.diagnostic.ncgenes.commons.GenerateReportCallable;
...
@Command(scope = "diagnostic-ncgenes", name = "generate-report", description = "Generate Report")
@Service
