...
import org.renci.canvas.binning.diagnostic.ncgenes.commons.UpdateDiagnosticBinsCallable;
...
@Command(scope = "diagnostic-ncgenes", name = "update-diagnostic-bins", description = "Update Diagnostic Bins")
@Service
